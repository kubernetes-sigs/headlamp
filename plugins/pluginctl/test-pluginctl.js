...
`;
const PACKAGE_NAME = "headlamp_kubescape";
const PACKAGE_URL =
  "https://artifacthub.io/packages/headlamp/kubescape-headlamp-plugin/headlamp_kubescape";
const PACKAGE_NAME_TO_UNINSTALL = "kubescape-plugin";
