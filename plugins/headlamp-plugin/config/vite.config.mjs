...
const externalModules = {
  ...
  '@headlamp-k8s/headlamp-plugin/lib/ApiProxy': 'pluginLib.ApiProxy',
  '@headlamp-k8s/headlamp-plugin/lib/Crd': 'pluginLib.Crd',
  '@headlamp-k8s/headlamp-plugin/lib/lib/k8s/crd': 'pluginLib.Crd',
  '@headlamp-k8s/headlamp-plugin/lib/k8s/crd': 'pluginLib.Crd',
  '@headlamp-k8s/headlamp-plugin/lib/K8s/crd': 'pluginLib.Crd',
  '@headlamp-k8s/headlamp-plugin/lib/K8s': 'pluginLib.K8s',
  '@headlamp-k8s/headlamp-plugin/lib/CommonComponents': 'pluginLib.CommonComponents',
  '@headlamp-k8s/headlamp-plugin/lib/Router': 'pluginLib.Router',
  '@headlamp-k8s/headlamp-plugin/lib/Utils': 'pluginLib.Utils',
  '@headlamp-k8s/headlamp-plugin/lib/Notification': 'pluginLib.Notification',
  ...
  '@headlamp-k8s/headlamp-plugin/lib/k8s': 'pluginLib.K8s',
  '@headlamp-k8s/headlamp-plugin/lib': 'pluginLib',
  '@headlamp-k8s/headlamp-plugin/lib/components/common': 'pluginLib.CommonComponents',
};
