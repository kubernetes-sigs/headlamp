...
// getClientSet returns a Kubernetes Clientset and RESTConfig for the given cluster and token.
func getClientSet(
...
// execInPod builds and executes a remote command inside a container.
func execInPod(
	ctx context.Context,
...
// VerifyDownloadTarget checks whether 'tar' is installed in the container
// and whether the target path exists and is readable.
//
// NOTE: This pre-check assumes a POSIX-compatible 'sh' shell is available
...
// VerifyUploadTarget checks whether 'tee' is available and if the destination
