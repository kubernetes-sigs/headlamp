/*
This file has been adapted from the kubernetes/client-go project:
https://github.com/kubernetes/client-go/blob/151d6316055ac2324ce7a2e3198cf2251303f325/rest/exec.go
...
func (a *Authenticator) refreshCredsLocked() error {
	...
	if interactive {
		...
		// On Windows, if the process is not interactive, we need to hide the
		// terminal window, in order to prevent it from flashing when the exec
		// plugin.
