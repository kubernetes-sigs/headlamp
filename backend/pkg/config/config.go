...
func (c *Config) Validate() error {
	if !c.InCluster && !c.OidcAllowContext && (c.OidcClientID != "" || c.OidcClientSecret != "" || c.OidcIdpIssuerURL != "" ||
...
func addOIDCFlags(f *flag.FlagSet) {
	f.Bool("oidc-allow-context", false, "Allow OIDC authentication for clusters defined in kubeconfig for non-inCluster mode")
