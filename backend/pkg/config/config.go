...
func ApplyMeDefaults(usernamePath, emailPath, groupsPath, userInfoURL string, namespacesURL string) (string, string, string, string, string) {
...
func setMeDefaults(config *Config) {
	config.MeUsernamePath, config.MeEmailPath, config.MeGroupsPath, config.MeUserInfoURL, config.MeNamespacesURL = ApplyMeDefaults(
