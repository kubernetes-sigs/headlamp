...
MutatingAdmissionPolicyBindingDetail.parameters = {
  msw: {
    handlers: {
      story: [
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1beta1/mutatingadmissionpolicybindings/label-pods-binding',
          () => HttpResponse.json(MUTATING_ADMISSION_POLICY_BINDING)
        ),
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1alpha1/mutatingadmissionpolicybindings/label-pods-binding',
          () => HttpResponse.json(MUTATING_ADMISSION_POLICY_BINDING)
        ),
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1beta1/mutatingadmissionpolicybindings',
          () => HttpResponse.error()
        ),
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1alpha1/mutatingadmissionpolicybindings',
          () => HttpResponse.error()
        ),
