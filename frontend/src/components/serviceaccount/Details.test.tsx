...
describe('ServiceAccountDetails', () => {
  ...
  it('builds extraInfo from the ServiceAccount fields', () => {
    render(
      <TestContext routerMap={{ namespace: 'default', name: 'my-sa' }}>
        <ServiceAccountDetails />
      </TestContext>
    ...
    expect(byName['Secrets']).toBeDefined();
    expect(byName['Image Pull Secrets']).toBeDefined();
    expect(byName['Automount Service Account Token']).toBeDefined();
  });
