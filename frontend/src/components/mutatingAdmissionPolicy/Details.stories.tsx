...
MutatingAdmissionPolicyDetail.parameters = {
  msw: {
    handlers: {
      story: [
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1beta1/mutatingadmissionpolicies/label-pods',
          () => HttpResponse.json(MUTATING_ADMISSION_POLICY)
        ),
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1alpha1/mutatingadmissionpolicies/label-pods',
          () => HttpResponse.json(MUTATING_ADMISSION_POLICY)
        ),
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1beta1/mutatingadmissionpolicies',
          () => HttpResponse.error()
        ),
        http.get(
          'http://localhost:4466/apis/admissionregistration.k8s.io/v1alpha1/mutatingadmissionpolicies',
          () => HttpResponse.error()
        ),
