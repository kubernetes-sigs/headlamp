...
describe('GCPLoginButton', () => {
  let isGKEClusterSpy: any;
  let initiateGCPLoginSpy: any;
  ...
  describe('Button props', () => {
    it('should apply custom variant', () => {
      ...
      const { container } = render(
        <GCPLoginButton cluster={cluster} variant="outlined" />
      );
    ...
    it('should apply custom color', () => {
      ...
      const { container } = render(
        <GCPLoginButton cluster={cluster} color="secondary" />
      );
    ...
    it('should apply custom size', () => {
      ...
      const { container } = render(
        <GCPLoginButton cluster={cluster} size="small" />
      );
    ...
    it('should apply fullWidth prop', () => {
      ...
      const { container } = render(
        <GCPLoginButton cluster={cluster} fullWidth={true} />
      );
    ...
    it('should not apply fullWidth when false', () => {
      ...
      const { container } = render(
        <GCPLoginButton cluster={cluster} fullWidth={false} />
      );
