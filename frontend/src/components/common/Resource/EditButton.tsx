...
import { KubeObject, KubeObjectClass, KubeObjectInterface } from '../../../lib/k8s/KubeObject';
...
function EditorActivityContent({
  ...
  const applyFunc = React.useCallback(updateFunc, [item, activityId, t, canPatch]);
