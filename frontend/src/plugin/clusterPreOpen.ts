...
const privateIndexOf = Array.prototype.indexOf;
...
export function registerClusterPreOpenHook(hook: ClusterPreOpenHook): boolean {
  if (privateApply(privateIndexOf, preOpenHooks, [hook]) !== -1) {
    return false;
  }
