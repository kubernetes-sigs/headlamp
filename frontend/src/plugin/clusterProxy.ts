...
/** Creates the legacy script runner only after AKS Desktop provenance is trusted. */
export function createAksDesktopRunCommand(
  isTrustedAksDesktop: boolean,
