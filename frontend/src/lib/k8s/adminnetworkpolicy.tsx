...
export interface AdminNetworkPolicySpec extends KubeObjectInterface {
  priority: number;
...
class AdminNetworkPolicy extends KubeObject<AdminNetworkPolicySpec> {
  ...
  static getBaseObject(): AdminNetworkPolicy {
    const baseObject = super.getBaseObject() as AdminNetworkPolicy;
    baseObject.spec = {
      priority: 100,
      subject: {
        pods: {
