...
export { default as DeviceClass } from './deviceClass';
export { default as ResourceClaim } from './resourceClaim';
export { default as ResourceClaimTemplate } from './resourceClaimTemplate';
