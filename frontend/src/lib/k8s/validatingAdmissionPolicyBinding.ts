...
import type { KubeMatchResources } from './validatingAdmissionPolicy';

export interface KubeValidatingAdmissionPolicyBinding extends KubeObjectInterface {
  spec: {
    matchResources?: KubeMatchResources;
    paramRef?: {
      name?: string;
      namespace?: string;
      parameterNotFoundAction?: string;
      selector?: import('./cluster').LabelSelector;
    };
    policyName?: string;
...
class ValidatingAdmissionPolicyBinding extends KubeObject<KubeValidatingAdmissionPolicyBinding> {
  ...
  get spec(): KubeValidatingAdmissionPolicyBinding['spec'] {
