...
{{/*
Build KUBECONFIG environment variable value from kubeconfigSecrets list
...
{{- $paths = append $paths (printf "/kubeconfigs/%s/%s" $secret.secretName (default "config" $secret.key)) }}
{{- end }}
{{- join ":" $paths }}
{{- end }}
