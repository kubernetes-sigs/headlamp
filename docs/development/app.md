...
- MCP child processes receive a minimal default environment. Add required variables to the MCP server's `env` configuration instead of relying on full desktop environment inheritance.
