...
| `apiName` | `static` | `string` | `'mutatingwebhookconfigurations'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiName` | - | [src/lib/k8s/mutatingWebhookConfiguration.ts:64](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/mutatingWebhookConfiguration.ts#L64) |
| `apiVersion` | `static` | `string` | `'admissionregistration.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiVersion` | - | [src/lib/k8s/mutatingWebhookConfiguration.ts:65](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/mutatingWebhookConfiguration.ts#L65) |
| `isNamespaced` | `static` | `boolean` | `false` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`isNamespaced` | - | [src/lib/k8s/mutatingWebhookConfiguration.ts:66](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/mutatingWebhookConfiguration.ts#L66) |
...
| `kind` | `static` | `string` | `'MutatingWebhookConfiguration'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`kind` | - | [src/lib/k8s/mutatingWebhookConfiguration.ts:63](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/mutatingWebhookConfiguration.ts#L63) |
...
[src/lib/k8s/mutatingWebhookConfiguration.ts:94](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/mutatingWebhookConfiguration.ts#L94)
...
```ts
patch(body: RecursivePartial<KubeMutatingWebhookConfiguration>): Promise<any>
```
...
| Parameter | Type |
| ------ | ------ |
| `body` | [`RecursivePartial`](../../api/v1/factories/type-aliases/RecursivePartial.md)\<[`KubeMutatingWebhookConfiguration`](../interfaces/KubeMutatingWebhookConfiguration.md)\> |
...
[src/lib/k8s/mutatingWebhookConfiguration.ts:68](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/mutatingWebhookConfiguration.ts#L68)
