...
Defined in: [lib/k8s/ingress.ts:93](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L93)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeIngress`](../interfaces/KubeIngress.md)\>
...
```ts
new Ingress(json: KubeIngress, cluster?: string): Ingress;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeIngress`](../interfaces/KubeIngress.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'ingresses'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/ingress.ts:95](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L95) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/ingress.ts:96](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L96) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/ingress.ts:97](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L97) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'Ingress'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/ingress.ts:94](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L94) |
...
Defined in: [lib/k8s/ingress.ts:135](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L135)
...
```ts
optional rules?: IngressRule[] | LegacyIngressRule[];
```
...
Defined in: [lib/k8s/ingress.ts:139](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L139)
...
Defined in: [lib/k8s/ingress.ts:147](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L147)
...
Defined in: [lib/k8s/ingress.ts:151](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L151)
...
Defined in: [lib/k8s/ingress.ts:99](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/ingress.ts#L99)

#### Returns

[`KubeIngress`](../interfaces/KubeIngress.md)
