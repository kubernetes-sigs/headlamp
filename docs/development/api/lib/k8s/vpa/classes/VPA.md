...
Defined in: [lib/k8s/vpa.ts:95](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L95)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeVPA`](../interfaces/KubeVPA.md)\>
...
```ts
new VPA(json: KubeVPA, cluster?: string): VPA;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeVPA`](../interfaces/KubeVPA.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'verticalpodautoscalers'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/vpa.ts:97](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L97) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'autoscaling.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/vpa.ts:98](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L98) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/vpa.ts:99](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L99) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'VerticalPodAutoscaler'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/vpa.ts:96](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L96) |
...
```ts
get referenceObject(): KubeObject<any> | null;
```

Defined in: [lib/k8s/vpa.ts:139](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L139)
...
Defined in: [lib/k8s/vpa.ts:131](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L131)
...
Defined in: [lib/k8s/vpa.ts:135](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L135)
...
Defined in: [lib/k8s/vpa.ts:159](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L159)

##### Returns

`RecommendationValue` \| `null` \| `undefined`
...
Defined in: [lib/k8s/vpa.ts:101](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L101)

#### Returns

[`KubeVPA`](../interfaces/KubeVPA.md)
...
Defined in: [lib/k8s/vpa.ts:113](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/vpa.ts#L113)
