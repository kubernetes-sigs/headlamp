...
Defined in: [lib/k8s/persistentVolumeClaim.ts:45](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L45)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubePersistentVolumeClaim`](../interfaces/KubePersistentVolumeClaim.md)\>
...
```ts
new PersistentVolumeClaim(json: KubePersistentVolumeClaim, cluster?: string): PersistentVolumeClaim;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubePersistentVolumeClaim`](../interfaces/KubePersistentVolumeClaim.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'persistentvolumeclaims'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/persistentVolumeClaim.ts:47](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L47) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/persistentVolumeClaim.ts:48](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L48) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/persistentVolumeClaim.ts:49](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L49) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'PersistentVolumeClaim'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/persistentVolumeClaim.ts:46](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L46) |
...
Defined in: [lib/k8s/persistentVolumeClaim.ts:71](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L71)
...
Defined in: [lib/k8s/persistentVolumeClaim.ts:75](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L75)
...
Defined in: [lib/k8s/persistentVolumeClaim.ts:51](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/persistentVolumeClaim.ts#L51)

#### Returns

[`KubePersistentVolumeClaim`](../interfaces/KubePersistentVolumeClaim.md)
