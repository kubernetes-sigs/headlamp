...
Defined in: [lib/k8s/daemonSet.ts:46](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L46)
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'daemonsets'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/daemonSet.ts:48](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L48) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'apps/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/daemonSet.ts:49](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L49) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/daemonSet.ts:50](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L50) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'DaemonSet'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/daemonSet.ts:47](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L47) |
...
Defined in: [lib/k8s/daemonSet.ts:53](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L53)
...
Defined in: [lib/k8s/daemonSet.ts:57](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L57)
...
Defined in: [lib/k8s/daemonSet.ts:93](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L93)
...
Defined in: [lib/k8s/daemonSet.ts:107](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L107)

Returns the observed generation of this DaemonSet.
...
Defined in: [lib/k8s/daemonSet.ts:97](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L97)
...
### getOwnedControllerRevisions()

```ts
getOwnedControllerRevisions(): Promise<ControllerRevision[]>;
```

Defined in: [lib/k8s/daemonSet.ts:111](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L111)

#### Returns

`Promise`\<[`ControllerRevision`](../../controllerRevision/classes/ControllerRevision.md)[]\>
...
Defined in: [lib/k8s/daemonSet.ts:249](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L249)

Get the revision history for this DaemonSet.
...
Defined in: [lib/k8s/daemonSet.ts:152](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L152)

Rolls back the DaemonSet to a specific or previous ControllerRevision.

This mirrors the behavior of `kubectl rollout undo daemonset/<name>`.
...
#### See
 ...
 - [K8s: Rolling Back a DaemonSet](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/#rolling-back-a-daemonset)
...
Defined in: [lib/k8s/daemonSet.ts:61](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/daemonSet.ts#L61)

#### Returns

[`KubeDaemonSet`](../interfaces/KubeDaemonSet.md)
