...
| `jsonData` | `public` | [`KubeNode`](../interfaces/KubeNode.md) | `undefined` | - | - | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`jsonData` | [src/lib/k8s/KubeObject.ts:47](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/KubeObject.ts#L47) |
...
| `apiName` | `static` | `string` | `'nodes'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiName` | - | [src/lib/k8s/node.ts:77](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L77) |
| `apiVersion` | `static` | `string` | `'v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiVersion` | - | [src/lib/k8s/node.ts:78](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L78) |
| `isNamespaced` | `static` | `boolean` | `false` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`isNamespaced` | - | [src/lib/k8s/node.ts:79](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L79) |
...
| `kind` | `static` | `string` | `'Node'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`kind` | - | [src/lib/k8s/node.ts:76](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L76) |
...
[src/lib/k8s/node.ts:85](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L85)
...
[src/lib/k8s/node.ts:81](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L81)
...
[src/lib/k8s/node.ts:106](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L106)
...
[src/lib/k8s/node.ts:110](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L110)
...
```ts
patch(body: RecursivePartial<KubeNode>): Promise<any>
```
...
| Parameter | Type |
| ------ | ------ |
| `body` | [`RecursivePartial`](../../api/v1/factories/type-aliases/RecursivePartial.md)\<[`KubeNode`](../interfaces/KubeNode.md)\> |
...
[`null` \| [`KubeMetrics`](../../cluster/interfaces/KubeMetrics.md)[], `null` \| [`ApiError`](../../api/v2/ApiError/classes/ApiError.md)]

#### Defined in

[src/lib/k8s/node.ts:89](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/node.ts#L89)
