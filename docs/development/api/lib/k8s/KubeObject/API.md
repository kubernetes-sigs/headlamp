...
| [KubeObjectInterfaceCreate](interfaces/KubeObjectInterfaceCreate.md) | KubeObjectInterfaceCreate is a version of KubeObjectInterface for creating objects where uid, creationTimestamp, etc. are optional |
...
| [useKubeGet](functions/useKubeGet.md) | Hook to fetch and watch a single Kubernetes object. |
| [useKubeList](functions/useKubeList.md) | Hook to fetch and watch a list of Kubernetes objects. |
