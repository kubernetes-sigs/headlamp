...
Defined in: [lib/k8s/storageClass.ts:29](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L29)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeStorageClass`](../interfaces/KubeStorageClass.md)\>
...
```ts
new StorageClass(json: KubeStorageClass, cluster?: string): StorageClass;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeStorageClass`](../interfaces/KubeStorageClass.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'storageclasses'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/storageClass.ts:31](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L31) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'storage.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/storageClass.ts:32](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L32) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `false` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/storageClass.ts:33](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L33) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'StorageClass'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/storageClass.ts:30](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L30) |
...
```ts
get allowVolumeExpansion(): boolean | undefined;
```

Defined in: [lib/k8s/storageClass.ts:64](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L64)
...
Defined in: [lib/k8s/storageClass.ts:44](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L44)
...
```ts
get mountOptions(): string[] | undefined;
```

Defined in: [lib/k8s/storageClass.ts:72](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L72)
...
Defined in: [lib/k8s/storageClass.ts:68](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L68)
...
Defined in: [lib/k8s/storageClass.ts:52](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L52)
...
Defined in: [lib/k8s/storageClass.ts:56](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L56)
...
Defined in: [lib/k8s/storageClass.ts:60](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L60)
...
Defined in: [lib/k8s/storageClass.ts:76](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L76)
...
Defined in: [lib/k8s/storageClass.ts:80](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L80)
...
Defined in: [lib/k8s/storageClass.ts:35](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/storageClass.ts#L35)

#### Returns

[`KubeStorageClass`](../interfaces/KubeStorageClass.md)
