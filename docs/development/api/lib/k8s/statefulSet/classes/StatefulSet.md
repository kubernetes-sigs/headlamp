...
Defined in: [lib/k8s/statefulSet.ts:49](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L49)
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'statefulsets'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/statefulSet.ts:51](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L51) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'apps/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/statefulSet.ts:52](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L52) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/statefulSet.ts:53](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L53) |
| <a id="property-isscalable"></a> `isScalable` | `static` | `boolean` | `true` | Whether the object is scalable, and should have a ScaleButton | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isScalable`](../../KubeObject/classes/KubeObject.md#property-isscalable) | - | [lib/k8s/statefulSet.ts:54](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L54) |
| <a id="property-kind"></a> `kind` | `static` | `string` | `'StatefulSet'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/statefulSet.ts:50](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L50) |
...
Defined in: [lib/k8s/statefulSet.ts:57](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L57)
...
Defined in: [lib/k8s/statefulSet.ts:61](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L61)
...
Defined in: [lib/k8s/statefulSet.ts:95](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L95)
...
Defined in: [lib/k8s/statefulSet.ts:104](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L104)
...
Defined in: [lib/k8s/statefulSet.ts:108](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L108)
...
Defined in: [lib/k8s/statefulSet.ts:246](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L246)
...
Defined in: [lib/k8s/statefulSet.ts:149](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L149)
...
#### See
 ...
 - [K8s: Rolling Back a StatefulSet](https://kubernetes.io/docs/concepts/workloads/controllers/statefulset/#rolling-back-a-statefulset)
...
Defined in: [lib/k8s/statefulSet.ts:65](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/statefulSet.ts#L65)

#### Returns

[`KubeStatefulSet`](../interfaces/KubeStatefulSet.md)
