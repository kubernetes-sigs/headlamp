...
Defined in: [lib/k8s/crd.ts:73](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L73)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeCRD`](../interfaces/KubeCRD.md)\>
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeCRD`](../interfaces/KubeCRD.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'customresourcedefinitions'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/crd.ts:75](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L75) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/crd.ts:76](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L76) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `false` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/crd.ts:77](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L77) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'CustomResourceDefinition'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/crd.ts:74](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L74) |
| <a id="property-readonlyfields"></a> `readOnlyFields` | `static` | `string`[] | `undefined` | Readonly field defined as JSONPath paths | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`readOnlyFields`](../../KubeObject/classes/KubeObject.md#property-readonlyfields) | - | [lib/k8s/crd.ts:79](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L79) |
...
Defined in: [lib/k8s/crd.ts:127](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L127)
...
Defined in: [lib/k8s/crd.ts:103](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L103)
...
Defined in: [lib/k8s/crd.ts:89](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L89)
...
Defined in: [lib/k8s/crd.ts:93](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L93)
...
Defined in: [lib/k8s/crd.ts:85](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L85)
...
Defined in: [lib/k8s/crd.ts:81](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L81)
...
Defined in: [lib/k8s/crd.ts:201](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L201)
...
Defined in: [lib/k8s/crd.ts:113](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L113)
...
Defined in: [lib/k8s/crd.ts:123](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L123)
...
Defined in: [lib/k8s/crd.ts:139](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L139)
...
```ts
makeCRClassOrNull(): typeof KubeObject | null;
```

Defined in: [lib/k8s/crd.ts:168](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/crd.ts#L168)
...
*typeof* [`KubeObject`](../../KubeObject/classes/KubeObject.md) \| `null`
