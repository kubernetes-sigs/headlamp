...
Defined in: [lib/k8s/referenceGrant.ts:61](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L61)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeReferenceGrant`](../interfaces/KubeReferenceGrant.md)\>
...
```ts
new ReferenceGrant(json: KubeReferenceGrant, cluster?: string): ReferenceGrant;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeReferenceGrant`](../interfaces/KubeReferenceGrant.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'referencegrants'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/referenceGrant.ts:63](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L63) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/referenceGrant.ts:64](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L64) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/referenceGrant.ts:65](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L65) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'ReferenceGrant'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/referenceGrant.ts:62](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L62) |
...
Defined in: [lib/k8s/referenceGrant.ts:71](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L71)

##### Returns

[`ReferenceGrantFrom`](../interfaces/ReferenceGrantFrom.md)[]
...
Defined in: [lib/k8s/referenceGrant.ts:67](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L67)
...
Defined in: [lib/k8s/referenceGrant.ts:75](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L75)

##### Returns

[`ReferenceGrantTo`](../interfaces/ReferenceGrantTo.md)[]
...
Defined in: [lib/k8s/referenceGrant.ts:79](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/referenceGrant.ts#L79)
