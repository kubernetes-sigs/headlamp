...
## See
 ...
 - [https://gateway-api.sigs.k8s.io/api-types/referencegrant/](https://gateway-api.sigs.k8s.io/api-types/referencegrant/) Gateway API definition for ReferenceGrant
...
[src/lib/k8s/referenceGrant.ts:54](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/referenceGrant.ts#L54)
