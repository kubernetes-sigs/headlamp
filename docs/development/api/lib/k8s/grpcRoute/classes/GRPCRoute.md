...
Defined in: [lib/k8s/grpcRoute.ts:78](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L78)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeGRPCRoute`](../interfaces/KubeGRPCRoute.md)\>
...
```ts
new GRPCRoute(json: KubeGRPCRoute, cluster?: string): GRPCRoute;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeGRPCRoute`](../interfaces/KubeGRPCRoute.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'grpcroutes'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/grpcRoute.ts:80](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L80) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/grpcRoute.ts:81](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L81) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/grpcRoute.ts:82](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L82) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'GRPCRoute'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/grpcRoute.ts:79](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L79) |
...
Defined in: [lib/k8s/grpcRoute.ts:88](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L88)
...
Defined in: [lib/k8s/grpcRoute.ts:96](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L96)
...
Defined in: [lib/k8s/grpcRoute.ts:92](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L92)

##### Returns

[`GRPCRouteRule`](../interfaces/GRPCRouteRule.md)[]
...
Defined in: [lib/k8s/grpcRoute.ts:84](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L84)
...
Defined in: [lib/k8s/grpcRoute.ts:100](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/grpcRoute.ts#L100)
