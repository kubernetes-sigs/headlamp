...
Defined in: [lib/k8s/networkpolicy.tsx:57](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L57)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeNetworkPolicy`](../interfaces/KubeNetworkPolicy.md)\>
...
```ts
new NetworkPolicy(json: KubeNetworkPolicy, cluster?: string): NetworkPolicy;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeNetworkPolicy`](../interfaces/KubeNetworkPolicy.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'networkpolicies'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/networkpolicy.tsx:59](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L59) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'networking.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/networkpolicy.tsx:60](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L60) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/networkpolicy.tsx:61](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L61) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'NetworkPolicy'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/networkpolicy.tsx:58](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L58) |
...
Defined in: [lib/k8s/networkpolicy.tsx:67](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L67)
...
Defined in: [lib/k8s/networkpolicy.tsx:63](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L63)
...
```ts
optional egress?: NetworkPolicyEgressRule[];
```

###### ingress?

```ts
optional ingress?: NetworkPolicyIngressRule[];
```
...
Defined in: [lib/k8s/networkpolicy.tsx:116](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L116)
...
Defined in: [lib/k8s/networkpolicy.tsx:71](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/networkpolicy.tsx#L71)

#### Returns

[`KubeNetworkPolicy`](../interfaces/KubeNetworkPolicy.md)
