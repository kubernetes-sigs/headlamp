...
Defined in: [lib/k8s/deployment.ts:29](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/deployment.ts#L29)
...
Defined in: [lib/k8s/deployment.ts:30](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/deployment.ts#L30)
...
```ts
optional minReadySeconds?: number;
```

#### progressDeadlineSeconds?

```ts
optional progressDeadlineSeconds?: number;
```

#### revisionHistoryLimit?

```ts
optional revisionHistoryLimit?: number;
```
...
Defined in: [lib/k8s/deployment.ts:45](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/deployment.ts#L45)
