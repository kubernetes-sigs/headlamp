...
Defined in: [lib/k8s/deployment.ts:50](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L50)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeDeployment`](../interfaces/KubeDeployment.md)\>
...
```ts
new Deployment(json: KubeDeployment, cluster?: string): Deployment;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeDeployment`](../interfaces/KubeDeployment.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'deployments'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/deployment.ts:52](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L52) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'apps/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/deployment.ts:53](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L53) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/deployment.ts:54](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L54) |
| <a id="property-isscalable"></a> `isScalable` | `static` | `boolean` | `true` | Whether the object is scalable, and should have a ScaleButton | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isScalable`](../../KubeObject/classes/KubeObject.md#property-isscalable) | - | [lib/k8s/deployment.ts:55](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L55) |
| <a id="property-kind"></a> `kind` | `static` | `string` | `'Deployment'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/deployment.ts:51](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L51) |
...
Defined in: [lib/k8s/deployment.ts:58](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L58)
...
Defined in: [lib/k8s/deployment.ts:62](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L62)
...
Defined in: [lib/k8s/deployment.ts:66](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L66)
...
Defined in: [lib/k8s/deployment.ts:81](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L81)
...
The current revision as a string, or '0' if not available.

#### See

[K8s: Deployment Revision History](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#revision-history-limit)
...
Defined in: [lib/k8s/deployment.ts:70](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L70)
...
```ts
getOwnedReplicaSets(): Promise<ReplicaSet[]>;
```

Defined in: [lib/k8s/deployment.ts:89](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L89)

Get all ReplicaSets owned by this Deployment.

#### Returns

`Promise`\<[`ReplicaSet`](../../replicaSet/classes/ReplicaSet.md)[]\>

Promise resolving to array of owned ReplicaSets.
...
Defined in: [lib/k8s/deployment.ts:228](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L228)
...
`Promise`\<[`RevisionInfo`](../../rollback/interfaces/RevisionInfo.md)[]\>
...
```ts
rollback(revisionOrOptions?: 
  | number
| RollbackOptions): Promise<RollbackResult>;
```

Defined in: [lib/k8s/deployment.ts:123](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L123)
...
| Parameter | Type |
| ------ | ------ |
| `revisionOrOptions?` | \| `number` \| [`RollbackOptions`](../../rollback/interfaces/RollbackOptions.md) |

#### Returns

`Promise`\<[`RollbackResult`](../../rollback/interfaces/RollbackResult.md)\>

Promise with rollback result containing success status and message.

#### See

 - [K8s: Rolling Back a Deployment](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#rolling-back-a-deployment)
...
Defined in: [lib/k8s/deployment.ts:266](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/deployment.ts#L266)

#### Returns

[`KubeDeployment`](../interfaces/KubeDeployment.md)
