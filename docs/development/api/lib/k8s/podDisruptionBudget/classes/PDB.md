...
| `jsonData` | `public` | [`KubePDB`](../interfaces/KubePDB.md) | `undefined` | - | - | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`jsonData` | [src/lib/k8s/KubeObject.ts:47](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/KubeObject.ts#L47) |
...
| `apiName` | `static` | `string` | `'poddisruptionbudgets'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiName` | - | [src/lib/k8s/podDisruptionBudget.ts:57](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L57) |
| `apiVersion` | `static` | `string` | `'policy/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`apiVersion` | - | [src/lib/k8s/podDisruptionBudget.ts:58](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L58) |
| `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`isNamespaced` | - | [src/lib/k8s/podDisruptionBudget.ts:59](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L59) |
...
| `kind` | `static` | `string` | `'PodDisruptionBudget'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).`kind` | - | [src/lib/k8s/podDisruptionBudget.ts:56](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L56) |
...
[src/lib/k8s/podDisruptionBudget.ts:75](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L75)
...
[src/lib/k8s/podDisruptionBudget.ts:67](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L67)
...
[src/lib/k8s/podDisruptionBudget.ts:71](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L71)
...
```ts
patch(body: RecursivePartial<KubePDB>): Promise<any>
```
...
| Parameter | Type |
| ------ | ------ |
| `body` | [`RecursivePartial`](../../api/v1/factories/type-aliases/RecursivePartial.md)\<[`KubePDB`](../interfaces/KubePDB.md)\> |
...
[src/lib/k8s/podDisruptionBudget.ts:61](https://github.com/zyzzmohit/headlamp/blob/5c039e27e936e8174f45bbfcab8979134d6fb3fc/frontend/src/lib/k8s/podDisruptionBudget.ts#L61)
