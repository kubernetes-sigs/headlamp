...
Defined in: [lib/k8s/podDisruptionBudget.ts:55](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L55)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubePDB`](../interfaces/KubePDB.md)\>
...
```ts
new PDB(json: KubePDB, cluster?: string): PDB;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubePDB`](../interfaces/KubePDB.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'poddisruptionbudgets'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/podDisruptionBudget.ts:57](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L57) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'policy/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/podDisruptionBudget.ts:58](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L58) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/podDisruptionBudget.ts:59](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L59) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'PodDisruptionBudget'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/podDisruptionBudget.ts:56](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L56) |
...
Defined in: [lib/k8s/podDisruptionBudget.ts:75](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L75)
...
Defined in: [lib/k8s/podDisruptionBudget.ts:67](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L67)
...
Defined in: [lib/k8s/podDisruptionBudget.ts:71](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L71)
...
Defined in: [lib/k8s/podDisruptionBudget.ts:61](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podDisruptionBudget.ts#L61)

#### Returns

[`KubePDB`](../interfaces/KubePDB.md)
