...
Defined in: [lib/k8s/tcpRoute.ts:30](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L30)

TCPRoute is a Gateway API type for routing TCP traffic from a Gateway listener to backend API objects.

## See

[https://gateway-api.sigs.k8s.io/reference/api-types/tcproute/](https://gateway-api.sigs.k8s.io/reference/api-types/tcproute/) Gateway API definition for TCPRoute

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeGatewayL4Route`](../../gateway/interfaces/KubeGatewayL4Route.md)\>
...
```ts
new TCPRoute(json: KubeGatewayL4Route, cluster?: string): TCPRoute;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeGatewayL4Route`](../../gateway/interfaces/KubeGatewayL4Route.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'tcproutes'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/tcpRoute.ts:32](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L32) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/tcpRoute.ts:33](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L33) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/tcpRoute.ts:34](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L34) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'TCPRoute'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/tcpRoute.ts:31](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L31) |
...
Defined in: [lib/k8s/tcpRoute.ts:44](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L44)

##### Returns

[`GatewayParentReference`](../../gateway/interfaces/GatewayParentReference.md)[]
...
Defined in: [lib/k8s/tcpRoute.ts:48](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L48)

##### Returns

[`GatewayRouteParentStatus`](../../gateway/interfaces/GatewayRouteParentStatus.md)[]
...
Defined in: [lib/k8s/tcpRoute.ts:40](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L40)

##### Returns

[`GatewayL4RouteRule`](../../gateway/interfaces/GatewayL4RouteRule.md)[]
...
```ts
get spec(): GatewayL4RouteSpec;
```

Defined in: [lib/k8s/tcpRoute.ts:36](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L36)

##### Returns

[`GatewayL4RouteSpec`](../../gateway/interfaces/GatewayL4RouteSpec.md)
...
Defined in: [lib/k8s/tcpRoute.ts:52](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/tcpRoute.ts#L52)
