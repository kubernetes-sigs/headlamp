# Class: BackendTLSPolicy

Defined in: [lib/k8s/backendTLSPolicy.ts:65](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L65)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeBackendTLSPolicy`](../interfaces/KubeBackendTLSPolicy.md)\>
...
```ts
new BackendTLSPolicy(json: KubeBackendTLSPolicy, cluster?: string): BackendTLSPolicy;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeBackendTLSPolicy`](../interfaces/KubeBackendTLSPolicy.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'backendtlspolicies'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/backendTLSPolicy.ts:67](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L67) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/backendTLSPolicy.ts:68](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L68) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/backendTLSPolicy.ts:69](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L69) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'BackendTLSPolicy'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/backendTLSPolicy.ts:66](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L66) |
...
Defined in: [lib/k8s/backendTLSPolicy.ts:71](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L71)

##### Returns

[`BackendTLSPolicySpec`](../interfaces/BackendTLSPolicySpec.md)
...
Defined in: [lib/k8s/backendTLSPolicy.ts:75](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L75)

##### Returns

[`BackendTLSPolicyTargetRef`](../interfaces/BackendTLSPolicyTargetRef.md)[]
...
Defined in: [lib/k8s/backendTLSPolicy.ts:79](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L79)

##### Returns

[`BackendTLSPolicyValidation`](../interfaces/BackendTLSPolicyValidation.md)
...
Defined in: [lib/k8s/backendTLSPolicy.ts:88](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/backendTLSPolicy.ts#L88)
