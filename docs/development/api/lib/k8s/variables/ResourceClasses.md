...
Defined in: [lib/k8s/index.ts:72](https://github.com/mishradwaterlaw/headlamp/blob/5944f5d61f18c73406d793336db6720caacb9130/frontend/src/lib/k8s/index.ts#L72)
...
```ts
LeaderWorkerSet: typeof LeaderWorkerSet;
```
...
```ts
Workload: typeof Workload = SchedulingWorkload;
```
