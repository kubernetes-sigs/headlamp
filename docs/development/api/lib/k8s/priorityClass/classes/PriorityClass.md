...
Defined in: [lib/k8s/priorityClass.ts:27](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L27)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubePriorityClass`](../interfaces/KubePriorityClass.md)\>
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubePriorityClass`](../interfaces/KubePriorityClass.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'priorityclasses'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/priorityClass.ts:29](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L29) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'scheduling.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/priorityClass.ts:30](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L30) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `false` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/priorityClass.ts:31](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L31) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'PriorityClass'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/priorityClass.ts:28](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L28) |
...
Defined in: [lib/k8s/priorityClass.ts:50](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L50)
...
Defined in: [lib/k8s/priorityClass.ts:46](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L46)
...
Defined in: [lib/k8s/priorityClass.ts:54](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L54)
...
Defined in: [lib/k8s/priorityClass.ts:42](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L42)
...
Defined in: [lib/k8s/priorityClass.ts:33](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/priorityClass.ts#L33)

#### Returns

[`KubePriorityClass`](../interfaces/KubePriorityClass.md)
