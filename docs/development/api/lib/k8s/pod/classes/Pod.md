...
Defined in: [lib/k8s/pod.ts:142](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L142)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubePod`](../interfaces/KubePod.md)\>
...
Defined in: [lib/k8s/pod.ts:150](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L150)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| `jsonData` | [`KubePod`](../interfaces/KubePod.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'pods'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/pod.ts:144](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L144) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/pod.ts:145](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L145) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/pod.ts:146](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L146) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'Pod'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/pod.ts:143](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L143) |
...
Defined in: [lib/k8s/pod.ts:155](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L155)
...
Defined in: [lib/k8s/pod.ts:159](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L159)
...
Defined in: [lib/k8s/pod.ts:338](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L338)
...
| ------ | ------ | ------ |
| `containerName` | `string` | The name of the ephemeral container to add |
| `image` | `string` | The container image to use |
| `command` | `string`[] | Optional command to run in the container (defaults to ['sh']) |
...
Defined in: [lib/k8s/pod.ts:292](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L292)
...
| ------ | ------ |
| `container` | `string` |
| `onAttach` | [`StreamResultsCb`](../../api/v1/streamingApi/type-aliases/StreamResultsCb.md) |
| `options` | [`StreamArgs`](../../api/v1/streamingApi/interfaces/StreamArgs.md) |
...
Defined in: [lib/k8s/pod.ts:163](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L163)
...
Defined in: [lib/k8s/pod.ts:309](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L309)
...
| ------ | ------ |
| `container` | `string` |
| `onExec` | [`StreamResultsCb`](../../api/v1/streamingApi/type-aliases/StreamResultsCb.md) |
...
Defined in: [lib/k8s/pod.ts:402](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L402)
...
Defined in: [lib/k8s/pod.ts:570](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L570)
...
Defined in: [lib/k8s/pod.ts:178](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L178)

#### Parameters

| Parameter | Type |
| ------ | ------ |
| ...`args` | \| \[`string`, `number`, `boolean`, [`StreamResultsCb`](../../api/v1/streamingApi/type-aliases/StreamResultsCb.md)\] \| \[`string`, `LogStreamResultsCb`, [`LogOptions`](../interfaces/LogOptions.md)\] |
...
Defined in: [lib/k8s/pod.ts:620](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/pod.ts#L620)

#### Returns

[`KubePod`](../interfaces/KubePod.md)
