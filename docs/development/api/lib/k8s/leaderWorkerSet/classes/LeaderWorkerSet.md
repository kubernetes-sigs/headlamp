...
Defined in: [lib/k8s/leaderWorkerSet.ts:48](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L48)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeLeaderWorkerSet`](../interfaces/KubeLeaderWorkerSet.md)\>
...
```ts
new LeaderWorkerSet(json: KubeLeaderWorkerSet, cluster?: string): LeaderWorkerSet;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeLeaderWorkerSet`](../interfaces/KubeLeaderWorkerSet.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'leaderworkersets'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/leaderWorkerSet.ts:50](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L50) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'leaderworkerset.x-k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/leaderWorkerSet.ts:51](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L51) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/leaderWorkerSet.ts:52](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L52) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'LeaderWorkerSet'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/leaderWorkerSet.ts:49](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L49) |
...
Defined in: [lib/k8s/leaderWorkerSet.ts:54](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L54)
...
Defined in: [lib/k8s/leaderWorkerSet.ts:58](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L58)
...
Defined in: [lib/k8s/leaderWorkerSet.ts:71](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L71)
...
Defined in: [lib/k8s/leaderWorkerSet.ts:88](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L88)
...
Defined in: [lib/k8s/leaderWorkerSet.ts:76](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L76)
...
Defined in: [lib/k8s/leaderWorkerSet.ts:115](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/leaderWorkerSet.ts#L115)

#### Returns

[`KubeLeaderWorkerSet`](../interfaces/KubeLeaderWorkerSet.md)
