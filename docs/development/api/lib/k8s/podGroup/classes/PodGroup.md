...
Defined in: [lib/k8s/podGroup.ts:153](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L153)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubePodGroup`](../interfaces/KubePodGroup.md)\>
...
```ts
new PodGroup(json: KubePodGroup, cluster?: string): PodGroup;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubePodGroup`](../interfaces/KubePodGroup.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'podgroups'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/podGroup.ts:155](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L155) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/podGroup.ts:156](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L156) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/podGroup.ts:161](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L161) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'PodGroup'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/podGroup.ts:154](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L154) |
...
```ts
get disruptionMode(): "PodGroup" | "Pod" | undefined;
```

Defined in: [lib/k8s/podGroup.ts:226](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L226)
...
Defined in: [lib/k8s/podGroup.ts:206](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L206)
...
Defined in: [lib/k8s/podGroup.ts:231](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L231)
...
Defined in: [lib/k8s/podGroup.ts:218](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L218)
...
Defined in: [lib/k8s/podGroup.ts:201](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L201)
...
```ts
get schedulingCondition(): 
  | KubeCondition
  | undefined;
```

Defined in: [lib/k8s/podGroup.ts:236](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L236)

The scheduling condition, under whichever name the served version uses.

##### Returns

  \| [`KubeCondition`](../../cluster/interfaces/KubeCondition.md)
  \| `undefined`
...
```ts
get spec(): PodGroupSpec;
```

Defined in: [lib/k8s/podGroup.ts:192](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L192)
...
Defined in: [lib/k8s/podGroup.ts:196](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L196)

##### Returns

  \| \{
  `conditions?`: [`KubeCondition`](../../cluster/interfaces/KubeCondition.md)[];
\}
  \| `undefined`
...
Defined in: [lib/k8s/podGroup.ts:211](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L211)
...
Defined in: [lib/k8s/podGroup.ts:174](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/podGroup.ts#L174)
...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `cluster` | `string` | The cluster to check. |

#### Returns

`Promise`\<`boolean`\>

true when the PodGroup resource is served.
