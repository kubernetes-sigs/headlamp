...
Defined in: [lib/k8s/volumeAttributesClass.ts:29](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L29)
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'volumeattributesclasses'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/volumeAttributesClass.ts:31](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L31) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'storage.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/volumeAttributesClass.ts:32](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L32) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `false` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/volumeAttributesClass.ts:33](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L33) |
...
Defined in: [lib/k8s/volumeAttributesClass.ts:39](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L39)
...
Defined in: [lib/k8s/volumeAttributesClass.ts:43](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L43)
...
Defined in: [lib/k8s/volumeAttributesClass.ts:47](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L47)
...
Defined in: [lib/k8s/volumeAttributesClass.ts:35](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/volumeAttributesClass.ts#L35)
