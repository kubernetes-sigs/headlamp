...
Defined in: [lib/k8s/volumeAttributesClass.ts:29](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L29)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeVolumeAttributesClass`](../interfaces/KubeVolumeAttributesClass.md)\>
...
```ts
new VolumeAttributesClass(json: KubeVolumeAttributesClass, cluster?: string): VolumeAttributesClass;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeVolumeAttributesClass`](../interfaces/KubeVolumeAttributesClass.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'volumeattributesclasses'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/volumeAttributesClass.ts:31](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L31) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'storage.k8s.io/v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/volumeAttributesClass.ts:32](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L32) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `false` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/volumeAttributesClass.ts:33](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L33) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'VolumeAttributesClass'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/volumeAttributesClass.ts:30](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L30) |
...
Defined in: [lib/k8s/volumeAttributesClass.ts:39](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L39)
...
Defined in: [lib/k8s/volumeAttributesClass.ts:43](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L43)
...
Defined in: [lib/k8s/volumeAttributesClass.ts:47](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L47)
...
```ts
static getBaseObject(): KubeVolumeAttributesClass;
```

Defined in: [lib/k8s/volumeAttributesClass.ts:35](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/volumeAttributesClass.ts#L35)

#### Returns

[`KubeVolumeAttributesClass`](../interfaces/KubeVolumeAttributesClass.md)
