...
Defined in: [lib/k8s/udpRoute.ts:30](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L30)

UDPRoute is a Gateway API type for routing UDP traffic from a Gateway listener to backend API objects.

## See

[https://gateway-api.sigs.k8s.io/reference/api-types/udproute/](https://gateway-api.sigs.k8s.io/reference/api-types/udproute/) Gateway API definition for UDPRoute
...
```ts
new UDPRoute(json: KubeGatewayL4Route, cluster?: string): UDPRoute;
```
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'udproutes'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/udpRoute.ts:32](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L32) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/udpRoute.ts:33](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L33) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/udpRoute.ts:34](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L34) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'UDPRoute'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/udpRoute.ts:31](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L31) |
...
Defined in: [lib/k8s/udpRoute.ts:44](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L44)
...
Defined in: [lib/k8s/udpRoute.ts:48](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L48)
...
Defined in: [lib/k8s/udpRoute.ts:40](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L40)
...
Defined in: [lib/k8s/udpRoute.ts:36](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L36)
...
Defined in: [lib/k8s/udpRoute.ts:52](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/udpRoute.ts#L52)
