...
Defined in: [lib/k8s/resourceQuota.ts:49](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L49)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeResourceQuota`](../interfaces/KubeResourceQuota.md)\>
...
```ts
new ResourceQuota(json: KubeResourceQuota, cluster?: string): ResourceQuota;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeResourceQuota`](../interfaces/KubeResourceQuota.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'resourcequotas'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/resourceQuota.ts:51](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L51) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'v1'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/resourceQuota.ts:52](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L52) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/resourceQuota.ts:53](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L53) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'ResourceQuota'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/resourceQuota.ts:50](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L50) |
...
Defined in: [lib/k8s/resourceQuota.ts:86](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L86)
...
Defined in: [lib/k8s/resourceQuota.ts:69](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L69)
...
Defined in: [lib/k8s/resourceQuota.ts:103](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L103)
...
Defined in: [lib/k8s/resourceQuota.ts:61](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L61)
...
Defined in: [lib/k8s/resourceQuota.ts:65](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L65)
...
Defined in: [lib/k8s/resourceQuota.ts:55](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/resourceQuota.ts#L55)

#### Returns

[`KubeResourceQuota`](../interfaces/KubeResourceQuota.md)
