...
Defined in: [lib/k8s/gateway.ts:76](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/gateway.ts#L76)

Gateway represents an instance of a service-traffic handling infrastructure by binding Listeners to a set of IP addresses.

## See

 - [https://gateway-api.sigs.k8s.io/reference/api-spec/main/spec/#gateway](https://gateway-api.sigs.k8s.io/reference/api-spec/main/spec/#gateway) Gateway API reference for Gateway
 - [https://gateway-api.sigs.k8s.io/reference/api-types/gateway/](https://gateway-api.sigs.k8s.io/reference/api-types/gateway/) Gateway API definition for Gateway
...
Defined in: [lib/k8s/gateway.ts:77](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/gateway.ts#L77)
...
```ts
optional listeners?: GatewayListener[];
```
...
Defined in: [lib/k8s/gateway.ts:82](https://github.com/mishradwaterlaw/headlamp/blob/fa170d1f3805256c3d561c39c317801d0e2be4b3/frontend/src/lib/k8s/gateway.ts#L82)
