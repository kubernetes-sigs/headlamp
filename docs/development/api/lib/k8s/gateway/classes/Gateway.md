...
Defined in: [lib/k8s/gateway.ts:144](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L144)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeGateway`](../interfaces/KubeGateway.md)\>
...
```ts
new Gateway(json: KubeGateway, cluster?: string): Gateway;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeGateway`](../interfaces/KubeGateway.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'gateways'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/gateway.ts:146](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L146) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string`[] | `undefined` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/gateway.ts:147](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L147) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/gateway.ts:148](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L148) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'Gateway'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/gateway.ts:145](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L145) |
...
Defined in: [lib/k8s/gateway.ts:150](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L150)
...
\[`key`: `string`\]: `any`;
  `gatewayClassName?`: `string`;
  `listeners?`: [`GatewayListener`](../interfaces/GatewayListener.md)[];
\}
  \| `undefined`
...
Defined in: [lib/k8s/gateway.ts:154](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L154)

##### Returns

  \| \{
\[`otherProps`: `string`\]: `any`;
  `addresses?`: [`GatewayStatusAddress`](../interfaces/GatewayStatusAddress.md)[];
  `conditions?`: [`KubeCondition`](../../cluster/interfaces/KubeCondition.md)[];
  `listeners?`: [`GatewayListenerStatus`](../interfaces/GatewayListenerStatus.md)[];
\}
  \| `undefined`
...
Defined in: [lib/k8s/gateway.ts:170](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L170)
...
Defined in: [lib/k8s/gateway.ts:162](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L162)

#### Returns

[`GatewayStatusAddress`](../interfaces/GatewayStatusAddress.md)[]
...
Defined in: [lib/k8s/gateway.ts:158](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L158)

#### Returns

[`GatewayListener`](../interfaces/GatewayListener.md)[]
...
```ts
getListenerStatusByName(name: string): 
  | GatewayListenerStatus
  | null;
```

Defined in: [lib/k8s/gateway.ts:166](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/gateway.ts#L166)
...
#### Returns
  ...
  \| [`GatewayListenerStatus`](../interfaces/GatewayListenerStatus.md)
  \| `null`
