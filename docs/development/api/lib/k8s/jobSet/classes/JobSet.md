...
Defined in: [lib/k8s/jobSet.ts:37](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L37)

## Extends

- [`KubeObject`](../../KubeObject/classes/KubeObject.md)\<[`KubeJobSet`](../interfaces/KubeJobSet.md)\>
...
```ts
new JobSet(json: KubeJobSet, cluster?: string): JobSet;
```
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`KubeJobSet`](../interfaces/KubeJobSet.md) |
| `cluster?` | `string` |
...
| <a id="property-apiname"></a> `apiName` | `static` | `string` | `'jobsets'` | Name of the resource, plural, used in API | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiName`](../../KubeObject/classes/KubeObject.md#property-apiname) | - | [lib/k8s/jobSet.ts:39](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L39) |
| <a id="property-apiversion"></a> `apiVersion` | `static` | `string` | `'jobset.x-k8s.io/v1alpha2'` | Group and version of the resource formatted as "GROUP/VERSION", e.g. "policy.k8s.io/v1". | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`apiVersion`](../../KubeObject/classes/KubeObject.md#property-apiversion) | - | [lib/k8s/jobSet.ts:40](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L40) |
| <a id="property-isnamespaced"></a> `isNamespaced` | `static` | `boolean` | `true` | Whether the object is namespaced. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`isNamespaced`](../../KubeObject/classes/KubeObject.md#property-isnamespaced) | - | [lib/k8s/jobSet.ts:41](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L41) |
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'JobSet'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/jobSet.ts:38](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L38) |
...
Defined in: [lib/k8s/jobSet.ts:58](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L58)
...
Defined in: [lib/k8s/jobSet.ts:62](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L62)
...
Defined in: [lib/k8s/jobSet.ts:74](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L74)
...
Defined in: [lib/k8s/jobSet.ts:89](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L89)

#### Returns

[`KubeJobSet`](../interfaces/KubeJobSet.md)
...
Defined in: [lib/k8s/jobSet.ts:48](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/jobSet.ts#L48)
