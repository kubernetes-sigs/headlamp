...
Defined in: [lib/k8s/namespace.ts:28](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/namespace.ts#L28)
...
| <a id="property-kind"></a> `kind` | `static` | `string` | `'Namespace'` | The kind of the object. Corresponding to the resource kind in Kubernetes. | [`KubeObject`](../../KubeObject/classes/KubeObject.md).[`kind`](../../KubeObject/classes/KubeObject.md#property-kind) | - | [lib/k8s/namespace.ts:29](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/namespace.ts#L29) |
| <a id="property-protected_namespaces"></a> `PROTECTED_NAMESPACES` | `readonly` | readonly `string`[] | `undefined` | Namespaces reserved by Kubernetes whose deletion can break the cluster. **See** https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ | - | - | [lib/k8s/namespace.ts:38](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/namespace.ts#L38) |
...
Defined in: [lib/k8s/namespace.ts:45](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/namespace.ts#L45)
...
Defined in: [lib/k8s/namespace.ts:55](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/namespace.ts#L55)
...
Defined in: [lib/k8s/namespace.ts:66](https://github.com/Rucha0901/headlamp/blob/db946f8d81732ed8fbecf4752fa84b86cab70c8b/frontend/src/lib/k8s/namespace.ts#L66)
