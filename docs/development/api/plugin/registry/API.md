...
| [ClusterSettingsViewLoadedEvent](interfaces/ClusterSettingsViewLoadedEvent.md) | Event fired when the cluster settings view is loaded. |
| [CreateProjectEvent](interfaces/CreateProjectEvent.md) | Event fired when a project is to be created. |
| [CreateResourceEvent](interfaces/CreateResourceEvent.md) | Event fired when creating a resource. |
| [DeleteProjectEvent](interfaces/DeleteProjectEvent.md) | Event fired when a project is to be deleted. |
...
| [PluginDetailsViewLoadedEvent](interfaces/PluginDetailsViewLoadedEvent.md) | Event fired when a plugin's settings details view is loaded. |
| [PluginListViewLoadedEvent](interfaces/PluginListViewLoadedEvent.md) | Event fired when the plugin list is loaded in the settings view. |
...
| [ProjectDetailsTabChangeEvent](interfaces/ProjectDetailsTabChangeEvent.md) | Event fired when the user switches to a different tab in the project details view. |
| [ProjectDetailsViewLoadedEvent](interfaces/ProjectDetailsViewLoadedEvent.md) | Event fired when a project is loaded in the project details view. |
| [ProjectListViewLoadedEvent](interfaces/ProjectListViewLoadedEvent.md) | Event fired when the project list view is loaded. |
...
| [SettingsViewLoadedEvent](interfaces/SettingsViewLoadedEvent.md) | Event fired when the general settings view is loaded. |
...
| [registerClusterEmptyState](functions/registerClusterEmptyState.md) | Replace the empty state shown on the Home page when no clusters are configured. |
