...
Headlamp expects plugins in a specific directory structure:
...
You can thus deploy Headlamp with e.g. the [Flux UI plugin image](ghcr.io/headlamp-k8s/headlamp-plugin-flux:v0.3.0) as an init container:
