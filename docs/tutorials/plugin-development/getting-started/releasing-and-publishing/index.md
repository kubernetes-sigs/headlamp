...
You will see webpack output similar to this:

```
asset main.js 248 KiB [emitted] (name: main)
orphan modules 186 KiB [orphan] 3 modules
runtime modules 1.25 KiB 6 modules
cacheable modules 401 KiB
  modules by path ./src/ 12.7 KiB
    ./src/index.tsx 8.31 KiB [built] [code generated]
    ...
webpack 5.98.0 compiled successfully in 3214 ms
```
