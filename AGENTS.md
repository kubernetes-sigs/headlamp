...
>
> **Build/Config files:**
> - `/package.json` - Root package with all npm scripts and Node.js version (>=22.6.0)
> - `/backend/go.mod` - Go version (1.26.0)
...
- **Runtimes/tools:**
  - Node.js >=22.6.0 (specified in `/package.json` engines field)
  - npm >=11.0.0 (specified in `/package.json` engines field)
  - Go 1.26.0 (specified in `/backend/go.mod`)
...
**Version Information:**
- Node.js: >=22.6.0 (from `/package.json`)
